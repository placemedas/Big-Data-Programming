...
wordsamp = words.filter(checkspace ).collect()
# Had to convert wordsamp to RDD as the value returned is tuple
finalwordsamp = sc.parallelize(wordsamp)

wordcount = finalwordsamp.reduceByKey(add)
